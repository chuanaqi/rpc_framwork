package com.lai.rpc.framework.registry.service.impl;



import com.lai.rpc.framework.registry.Utils.ZookeeperUtil;
import com.lai.rpc.framework.registry.common.Constant;
...
public class ZookeeperRegistryService implements IRegistryService {
    ...
    public void register(String data) {
        try {
            if (data != null) {
                ZooKeeper zk = ZookeeperUtil
                        .connectServer(registryAddress, Constant.ZK_SESSION_TIMEOUT,latch);
                if (zk != null) {
                    createNode(zk, data);
                }
            }
